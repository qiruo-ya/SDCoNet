...
from .detr_layers import (DetrTransformerDecoder, DetrTransformerDecoderLayer,DetrTransformerEncoderLayer_vis,
...
class DeformableDetrTransformerEncoder_vis(DetrTransformerEncoder):
    """Transformer encoder of Deformable DETR."""

    def _init_layers(self) -> None:
        """Initialize encoder layers."""
        self.layers = ModuleList([
            DeformableDetrTransformerEncoderLayer_vis(**self.layer_cfg)
            for _ in range(self.num_layers)
        ])
...
class DeformableDetrTransformerEncoderLayer_vis(DetrTransformerEncoderLayer_vis):
    """Encoder layer of Deformable DETR."""
