...
from .focal_loss import FocalCustomLoss, FocalLoss, sigmoid_focal_loss, sigmoid_focal_loss1
...
from .salience_loss import SalienceCriterion

__all__ = [
    'accuracy', 'Accuracy', 'cross_entropy', 'binary_cross_entropy',
    'mask_cross_entropy', 'CrossEntropyLoss', 'sigmoid_focal_loss', 'sigmoid_focal_loss1',
    ...
    'DDQAuxLoss', 'CrossEntropyCustomLoss', 'FocalCustomLoss','SalienceCriterion'
]
